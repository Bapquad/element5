...
mobile400.Effects( 'ul#list' ).css(
{
	marginLeft: '10px', 
	marginRight: '10px'
});
var list = mainPage.Equip( element5.Create( 'ul#list' ) ).css( { 'padding-left': '10px', 'list-style': 'none', 'padding':'10px', 'background':'#27183a', 'margin': '15px auto 0', 'max-width': '550px', 'border': '1px solid #ccc1da' } );
