...
function Factory() 
{
	...
	{ 
		...
		[
			...
			function( module ) 								// pack require ( 1 ) 
			{
				...
				{ 
					...
					if( BODY != undefined  && BODY.el5 == undefined ) 
					{
						...
						element5( BODY ).addEventListener('contextmenu', function(event){event.preventDefault()}, false);
				...
				element5.Extend = function( applier, hier ) 
				{
					for( var x in hier ) 
					{
						...
						if( typeof hier[x] == 'function' && undefined!==Object.getOwnPropertyDescriptor(hier, x) ) 
						{
			...
			function( module, __require_pak__ ) 		// pack require ( 2 ) 
			{
			...
			function( module, __require_pak__ ) 		// pack require ( 3 ) 
			{
				var Timeline = 
				{
			...
			function( module, __require_pak__ ) 		// pack require ( 4 ) 
			{
				var spriteModifier = 
				{
					Run: function( fps )
			...
			function( module, __require_pak__ ) 		// pack require ( 5 )
			{
				// TODO
				var Media = 
				{
			...
			function( module, __require_pak__ ) 		// pack require ( 7 ) 
			{
				// TODO: 
			...
			function( module, __require_pak__ ) 		// pack require ( 9 ) 
			{
