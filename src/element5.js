...
function Export(modules) {
  ...
  function __require_pak__(moduleId) {
    ...
    modules[moduleId].call(module.exports, module, __require_pak__);
...
function Factory() {
  return (function (modules) {
    ...
    function (module, __require_pak__) {
      module.exports.element5 = __require_pak__(1);
      module.exports.style5 = __require_pak__(2);
      module.exports.timeline5 = __require_pak__(3);
      module.exports.motion5 = __require_pak__(4);
      module.exports.media5 = __require_pak__(5);
      module.exports.request5 = __require_pak__(6);
      module.exports.bom5 = __require_pak__(7);
      module.exports.store5 = __require_pak__(8);
      module.exports.geo5 = __require_pak__(9);
      module.exports.solution5 = __require_pak__(10);
    },
    function (module) {
      "use strict";
        ...
        try {
          if (typeof target == "string") {
            ...
            if (len) {
              ...
              // Check pass
              if (/^(.|#)[a-zA-Z0-9\-]+$/.exec(target) == null) return;
              if (queryType == "#") // Single
              {
            ...
            if (target.nodeType != undefined) {
              if (parseInt(target.nodeType) !== 1) return;
      ...
      var StyleModifier = {
        ...
        AddContext: function (ctx) {
          if (typeof this.el5 == "string") {
            this.CssSelf.AddSelector(
              ctx + " " + this.tagName.toLowerCase() + "." + this.el5,
            );
          }
          return this;
        },
      ...
      var DOMModifier = {
        ...
        HasClass: function (clsn, target) {
          ...
          if (el.getAttribute) {
            ...
            return (
              clsnAttr != null && clsnAttr != "" && clsnAttr.indexOf(clsn) >= 0
            );
          }
          return false;
        },
        ...
        RemoveClass: function (clsn) {
          if (clsn.indexOf("el5_") >= 0) return this;
      ...
      var JSONModifier = {
        ...
        DeleteData: function (name) {
          try {
            if (name == undefined)
              throw "Delete the data need the name specify.";
            var el = this;
            var len = el.BackData.length;
        ...
        SetBackData: function (name, value) {
          try {
            ...
            if (typeof value != "string")
              throw "The value must be string value.";
        ...
        GetBackData: function (name) {
          ...
          for (var i = 0; i < len; i++) {
            if (el.attributes[i].name.indexOf("data-") >= 0) {
              ...
              else if ("data-" + name === el.attributes[i].name)
      ...
      var UIXModifier = {
          ...
          function defaultOver(el, evt) {
            try {
              ...
              if (touching) {
                ...
                el.css({
                  left: clientX - el.layerX + "px",
                  top: clientY - el.layerY + "px",
                });
              }
        ...
        Droppable: function (ondrop) {
          ...
          el.checkIsHited = function (item) {
            ...
            if (
              !(x > selfLeft && x < selfRight && y > selfTop && y < selfBottom)
            ) {
              return false;
            }
      ...
      element5.GetBody = function () {
        ...
        if (BODY != undefined && BODY.el5 == undefined) {
          BODY.scrollToY = function (position, duration) {
            ...
            var anime = element5.Math.ComAni1(
              BODY.scrollTop,
              position,
              duration,
            );
          ...
          element5(BODY).addEventListener(
            "contextmenu",
            function (event) {
      ...
      element5.Extend = function (applier, hier) {
        for (var x in hier) {
          ...
          var sx = x.charAt(0).toLowerCase() + x.slice(1);
          if (
            typeof hier[x] == "function" &&
            undefined !== Object.getOwnPropertyDescriptor(hier, x)
          ) {
            if (applier[x] === undefined) {
              applier[x] = hier[x];
            }
            if (applier[sx] === undefined) {
              applier[sx] = hier[x];
            }
            if (applier[lx] === undefined) {
              applier[lx] = hier[x];
            }
          } else {
    ...
    function (module, __require_pak__) {
      // pack require ( 2 )
      var element5 = __require_pak__(1);
      ...
      ((Style.AddRelateCss = function () {
        ...
        (Style.AddTimeLine = function (timeline) {
          ...
          Style.sheet.attach(
            "@keyframes " + timeline.name + " { " + content.join(" ") + " } ",
            index,
          );
        ...
        (Style.Find = function (selector, autoplus) {
          ...
          if (len) {
            for (var i = 0; i < len; i++) {
              if (
                selector ==
                (this.sheet.cssRules[i].selectorText ||
                  this.sheet.cssRules[i].name)
              ) {
      ...
      Style.ruleModifier = {
        ...
        css: function () {
          if (arguments.length) {
            if (arguments.length == 1) this.SetStyles(arguments[0]);
        ...
        Css: function () {
          var rule = this;
          if (arguments.length) {
            if (arguments.length == 1) rule.SetStyles(arguments[0]);
            else if (arguments.length == 2)
          ...
          media.features.forEach(function (item, index) {
            ...
            if (featureItem.length === 2) {
              ...
              if (featureTypes.indexOf(featureItem.name) >= 0) {
                features.push(
                  "( " + featureItem.name + ": " + featureItem.value + " )",
                );
              }
            }
          });
      ...
      Style.AddLine(".invisible").SetStyles({
        visibility: "hidden",
        opacity: "0",
      });
          ...
          function enumDeviceErrorHandle(e) {
            if (e.name.indexOf("NotFoundError") >= 0) {
              ...
              console.error(
                "The following error occurred: " +
                  e.name +
                  ". Please check your microphone or Allow access microphone on webbrowser and try again.",
              );
            }
            if (undefined != callback) {
      ...
      var Bom =
        // Browser Object Model.
        {
          Browser: {
            ...
            IsBlink: (function () {
              var out =
                !(navigator.userAgent.match(/Opera|OPR\//) ? true : false) &&
          ...
          Device: {
            ...
            IsAndroid: (function () {
              return (
                /android/i.test(uas) && uas.indexOf("windows phone") === -1
              );
            })(),
        ...
        Open: function (storageType) {
          try {
            ...
            function suftByExpireDS() {
              ...
              var db_name = domain;
              var branch = window.location.pathname.slice(
                0,
              ...
              var recordModifier = {
                ...
                Destroy: function () {
                  ...
                  else delete coreDS.priRec[record.key];
                },
              ...
              var coreDS = {
                ...
                Insert: function (queryString) {
                  return "id, key, value, branch, expires, timestamp from here where id = 10 limit 10, 19";
                },
                Update: function (queryString) {
                  return "(key, value, expires, timestamp) values ( username, Huy Cuong, 3 days, current ) from here";
                },
                Select: function (queryString) {
                  return "key = username, value = Huy Cuong from here where id = 10";
                },
                Delete: function (queryString) {
                  return "from here where id = 10";
                },
                Empty: function (queryString) {
                  return "from here";
                },
                Query: function (queryString) {
                  return "select: * from here where id = 1 limit 10";
                },
                Custom: function (cookieString) {
                  return "01={}, path=/, expires=UTCString";
                },
                ...
                Public: function () {
                    ...
                    for (var i = 0; i < len; i++) {
                      ...
                      if (item.key == key && item.value.meta.branch == "/") {
                        if (myCore.pubRec[key] == undefined) {
                          myCore.pubRec[key] = element5.Extend(
                            item,
                            recordModifier,
                          );
                        }
                  ...
                  document.cookie = cookieString;
                  return (myCore.pubRec[key] = element5.Extend(
                    record,
                    recordModifier,
                  ));
                },
                ...
                Private: function () {
                  ...
                  if (arguments.length == 1) {
                    ...
                    for (var i = 0; i < len; i++) {
                      if (
                        records[i].key == key &&
                        records[i].value.meta.branch == branch
                      ) {
                        return (myCore.priRec[key] = element5.Extend(
                          records[i],
                          recordModifier,
                        ));
                      }
            ...
            function suftByLocalDS() {
               ...
               */
              if (
                storageType != "LocalDataSim" &&
                storageType != "SessionDataSim"
              ) {
                return;
              } else {
                var storageAdapter =
                  storageType != "LocalDataSim" ? sessionStorage : localStorage;
              }
              ...
              var DSDescription = {
                lds_flatform:
                  storageAdapter == localStorage ? "LDSim" : "SDSim",
                lds_prefix: "lds_",
                ...
                for (var i = 0; i < len; i++) {
                  ...
                  if (pat != null) {
                    ...
                    if (scope == "/" || scope == branch) {
                      coreDS.pubRec[key] = element5.Extend(
                        item,
                        variableModifier,
                      );
                    }
              ...
              dbOpenRequest.onsuccess = function (event) {
                var dbModifier = {
                  From: function () {
                    ...
                    var objStoreMode =
                      arguments[1] || IDBTransaction.READ_WRITE;
                    var database = this;
            ...
            database.cdb5_chemmaset = ["schools", "students"];
        ...
        return new (function GeoClass() {
          ...
          this.ShowMyPositionOnMap = function () {
            ...
            return (
              ...
              latlon +
              "&zoom=17&size=400x300&sensor=false"
            );
          };
      ...
      var Solution = {
          ...
          function _extendArray(arr, callback, framework) {
            ...
            function generateOverloadedFunction(target, methodName, self) {
              return function () {
                ...
                var newValue = Array.prototype[methodName].apply(
                  target,
                  arguments,
                );
              ...
              if (route.length) {
                ...
                if (vars) {
                  ...
                  for (var i = 0; i < vars.length; i++) {
                    inp = /([a-zA-Z0-9\_]+)=([a-zA-Z0-9\_]+)/g.exec(
                      vars[i].trim(),
                    );
                    $_get[inp[1]] = inp[2];
                  }
        ...
        Binding: (function () {
          return function (viewmodel, context) {
            var root =
              viewmodel instanceof Function ? new viewmodel() : viewmodel;
            var doc =
              !!context && context !== undefined && typeof context === "string"
                      ...
                      cb.forEach(function (el) {
                        ...
                        for (var i = 0; i < attrs.length; i++) {
                          ...
                          if (extp == "text") {
                            ...
                            if (
                              (el.nodeName.toLowerCase().trim() == "input" &&
                                el.type == undefined) ||
                              el.type == "text"
                            ) {
          ...
          if (mode === "ON") {
            ...
            element5.WriteError = function (string) {
              if (window.timeOutErrorMessageCounter) {
                ...
                errormessagetextshow = element5("#error-message").css({
                  position: "fixed",
                  bottom: "0px",
                  left: "0px",
                  width: "100%",
            ...
            element5.WriteAlert = function (string) {
              if (window.timeOutAlertMessageCounter) {
                ...
                alertmessagetextshow = element5("#alert-message").css({
                  position: "fixed",
                  bottom: "0px",
                  left: "0px",
                  width: "100%",
